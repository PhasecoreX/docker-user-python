def main(ctx):
    ...
    all_image_tags_arches = [{'tags': ['3.6-alpine'], 'arches': ['arm64v8', 'arm32v7', 'arm32v6', 'amd64'], 'dockerfile': 'docker-user-image/Dockerfile.alpine'}, {'tags': ['3.6-slim'], 'arches': ['arm64v8', 'arm32v7', 'arm32v5', 'amd64'], 'dockerfile': 'docker-user-image/Dockerfile.debian'}, {'tags': ['3.6'], 'arches': ['arm64v8', 'arm32v7', 'arm32v5', 'amd64'], 'base_tag': '3.6-buster', 'dockerfile': 'docker-user-image/Dockerfile.debian'}, {'tags': ['3.7-alpine'], 'arches': ['arm64v8', 'arm32v7', 'arm32v6', 'amd64'], 'dockerfile': 'docker-user-image/Dockerfile.alpine'}, {'tags': ['3.7-slim'], 'arches': ['arm64v8', 'arm32v7', 'arm32v5', 'amd64'], 'dockerfile': 'docker-user-image/Dockerfile.debian'}, {'tags': ['3.7'], 'arches': ['arm64v8', 'arm32v7', 'arm32v5', 'amd64'], 'base_tag': '3.7-buster', 'dockerfile': 'docker-user-image/Dockerfile.debian'}, {'tags': ['3.8-alpine'], 'arches': ['arm64v8', 'arm32v7', 'arm32v6', 'amd64'], 'dockerfile': 'docker-user-image/Dockerfile.alpine'}, {'tags': ['3.8-slim'], 'arches': ['arm64v8', 'arm32v7', 'arm32v5', 'amd64'], 'dockerfile': 'docker-user-image/Dockerfile.debian'}, {'tags': ['3.8'], 'arches': ['arm64v8', 'arm32v7', 'arm32v5', 'amd64'], 'base_tag': '3.8-buster', 'dockerfile': 'docker-user-image/Dockerfile.debian'}, {'tags': ['3.9-alpine', '3-alpine'], 'arches': ['arm64v8', 'arm32v7', 'arm32v6', 'amd64'], 'dockerfile': 'docker-user-image/Dockerfile.alpine'}, {'tags': ['3.9-slim', '3-slim'], 'arches': ['arm64v8', 'arm32v7', 'arm32v5', 'amd64'], 'dockerfile': 'docker-user-image/Dockerfile.debian'}, {'tags': ['latest', '3.9', '3'], 'arches': ['arm64v8', 'arm32v7', 'arm32v5', 'amd64'], 'base_tag': 'buster', 'dockerfile': 'docker-user-image/Dockerfile.debian'}]
    other_options = {
        "pre_build_commands": {
            "image": "docker:git",
            "commands": [
